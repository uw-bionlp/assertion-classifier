...
public class StringUtil {
    ...
    /**
     * Splits a formated <tt>String</tt> object according to a given delimiter
     * <tt>String</tt> object. If multiple occurences of the delimiter are present,
     * the split is perfomed at the first occurence.
     *
     * @param rep   the formated string to be split
     * @param delim the delimiter the establishes the split position
     * @throws UnsupportedStringFormatException if <code>delim</code> is not found
     *                                          in <code>rep</code>.
    ...
    public static Pair<String, String> split2First(String rep, String delim) {
        ...
        if (pos == -1)
            throw new UnsupportedStringFormatException("[" + delim + "] does not exist in [" + rep + "]");
     ...
     * This method does not test whether the input string is a valid file path.
     * Therefore, can also split a directory path into the same path and empty
     * string.
     *
     * @param filePath the path to be split
     * @return a pair of strings with the first string representing the root path,
     *         the second - the file name. When the <code>File.separator</code> does
     *         not exist in <code>filePath</code> the first string will be empty.
    ...
    public static Pair<String, String> split2FilePath(String filePath) {
        // Note: is different from split2Last(fileName, File.separator); because it also
        // keeps
    ...
    /**
     * Splits a file path into a its root path, base name, and extension. It also
     * handles the cases when the <code>File.separator</code> or extension delimiter
     * <tt>.</tt> does not exist in the file path.
     *
     * @param filePath the path to be split
     * @return a triple of strings with the first string representing the root path,
     *         the second - basename, and the third - the its extension. When the
     *         <code>File.separator</code> does not exist in <code>filePath</code>
     *         the first string will be empty. In cases when the extension delimiter
     *         <tt>.</tt> does not exist the third string will be empty.
     * @ady.rep StrUtil.basename StrUtil.splitFilePath StrUtil.filenamenoext
     */
    ...
    /**
     * Splits a file name string into its basename and extension. It also handles
     * the cases when the extension delimiter <tt>.</tt> does not exist in the file
     * name.
     *
     * @param fileName the file name string to be split
     * @return a pair of strings with the first string representing the basename and
     *         the second string the extension. When the extension delimiter
     *         <tt>.</tt> does not exist the second string will be empty.
     * @ady.rep StrUtil.basename StrUtil.splitFilePath StrUtil.filenamenoext
     */
    ...
    /**
     * Converts an int value into string and left pads the string with a given
     * character.
     * 
     * @param value the int value to convert
     * @param size  specifies how many characters to fill out
     * @param ch    the character to fill out the space
     * @return the left padded string (e.g., for <code>(73,7,0)</code>, it the
     *         return string will be <code>0000073</code>).
     ...
     * @return a new string with the <code>prefix</code> removed. If the
     *         <code>prefix</code> does not end the <code>content</code>, then the
     *         <code>content</code> is returned.
     ...
     * @return a new string with the <code>suffix</code> removed. If the
     *         <code>suffix</code> does not end the <code>content</code>, then the
     *         <code>content</code> is returned.
     */
     ...
     * 
     * @param content the string from which the given suffix and prefix will be
     *                removed
     * @param prefix  the specified prefix to be removed
     * @param suffix  the specified suffix to be removed
     * @return a new string with the <code>prefix</code> and <code>suffix</code>
     *         removed. If the <code>prefix</code> / <code>suffix</code> does not
     *         begin / end the <code>content</code>, then the <code>content</code>
     *         is returned.
     */
