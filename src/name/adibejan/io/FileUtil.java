...
public class FileUtil {
    ...
    /**
     * Filters all the files from a given directory that have their extension mached
     * on a specified string.
     *
     * @param dirPath   the directory with the files to filter
     * @param extension the string representing a specific extension. If a
     *                  <tt>.</tt> delimiter is present, it has to be inside this
     *                  string.
     * @return all the files from <code>dirPath</code> whose extension match
    ...
    /**
     * Copies the content of one stream into another (the classic approach with
     * buffer). The method does not close the streams.
     * 
     * @ady.rep copyFile1
     */
