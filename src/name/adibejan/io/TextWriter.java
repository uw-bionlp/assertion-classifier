...
public class TextWriter {
  ...
  /**
   * Creates a TextWriter to the System.out with the <code>"UTF-8"</code> charset encoding.
   *
   */
  public TextWriter() {
    try {
  ...
  /**
   * Creates a TextWriter with a specified file name, append mode, and default charset encoding.
   *
   * @param fileName the name of the file
   * @param append if true it will perform the writing opperations in append mode
   */
   ...
   *
   * @param fileName the name of the file
   * @param charsetName the charset encoding. See <code>java.nio.charset.Charset</code>
   * for options of encodings.
   */
  ...
  /**
   * Creates a TextWriter with a specified file name, append mode, and charset encoding.
   *
   * @param fileName the name of the file
   * @param append if true it will perform the writing opperations in append mode
   * @param charsetName the charset encoding. See <code>java.nio.charset.Charset</code>
  ...
  /**
   * Creates a TextWriter with a specified file, append mode, and charset encoding.
   *
  ...
  /**
   * Creates a TextWriter with a specified file name, append mode, and option 
   * for <code>"UTF-8"</code> charset encoding.
   *
   * @param fileName the name of the file
   * @param append if true it will perform the writing opperations in append mode
   * @param utf8Charset if true it will use the <code>"UTF-8"</code> charset encoding.
   */
  public TextWriter(String fileName, boolean append, boolean utf8Charset) {
    if(utf8Charset) setWriter(new File(fileName), append, "UTF-8");
    else setWriter(new File(fileName), append);
  }
  
  /**
   * Creates a TextWriter with a specified file, append mode, and option 
   * for <code>"UTF-8"</code> charset encoding.
   *
   * @param file the file to write into
   * @param append if true it will perform the writing opperations in append mode
  ...
  public TextWriter(File file, boolean append, boolean utf8Charset) {
    if(utf8Charset) setWriter(file, append, "UTF-8");
    else setWriter(file, append);
  }
   ...
   * @param append specifies whehter the writing operations should be perfomed in 
   * append mode or not.
   * @param charsetName specifies the charset encoding (e.g., <code>"UTF-8"</code>)
   */
  private void setWriter(File file, boolean append, String charsetName) {
    try {
      pw = new PrintWriter(new BufferedWriter(new OutputStreamWriter(new FileOutputStream(file, append), charsetName)));
    } catch (UnsupportedEncodingException uee) { 
