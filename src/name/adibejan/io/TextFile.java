...
public class TextFile {
   ...
   * This method assumes default encoding.
   *
  ...
  /**
   * Writes a string in a file and then closes the file. 
   * This method assumes default encoding.
   *
   * @ady.rep setContents
   */
  ...
  /**
   * Writes a string into a given file and then closes the file (it also append a new line at the end)
   */
