...
public class EnumUtil {    
   ...
   *
   */
  public static <T extends Enum<T>> EnumSet<T> getSet(Class<T> enumClass, 
  ...
  @SuppressWarnings("unchecked")
    ...
    if (fieldOrdinal < 0 || fieldOrdinal >=  values.length) 
      throw new IndexOutOfBoundsException("Invalid ordinal ["+fieldOrdinal+"] for class"+enumClass.getName());
