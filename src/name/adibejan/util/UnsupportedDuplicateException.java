...
/**
 * Runtime expception thrown when no duplicates are allowed in a particular object collection.
 *
...
public class UnsupportedDuplicateException extends RuntimeException {
  ...
  /**
   * Constructs a <code>UnsupportedDuplicateException</code> with no detail message.
   */
